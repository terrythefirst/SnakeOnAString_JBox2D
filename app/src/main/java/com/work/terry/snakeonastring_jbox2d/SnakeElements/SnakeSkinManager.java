...
public class SnakeSkinManager {
    ...
    public static SnakeSkin getSnakeSkin (int SkinNumber){
        return skinMap.get(SkinNumber);
    }
    public static SnakeNodeSkinInfo getSkinNodeInfo(int SkinNumber, int nodeNumber){
